...
import Logo from "../../assets/help/logo.jpg";
...
import Basic from "../../assets/help/basic.png";
import Fundamental from "../../assets/help/fundamental.png";
...
import Any_action from "../../assets/help/any action.png";
          ...
          <div className="row  item-center ">
            ...
            <div className="haniya">
                    ...
                    <li className="space-y-2">
                      ...
                      <ul className="pl-8 space-y-2">
                        ...
                        <li className="flex justify-between">
                          <a
                            href="javascript:void(0);"
                            onClick={() => handleClick("Download All Receipt")}
                            className="text-blue-600 hover:underline"
                          >
              ...
              <div>
                ...
                {/* <ul className=" item-center  my-4">
                  <li>
                    The FTS Web Application opens to the login page, serving as
                    the initial gateway to access the various features and
                    functionalities it offers.
                  </li>
                  <li>
                    Users initiate their account with the FTS Web Application by
                    landing on the login page via the URL below.
                  </li>
                  <li>
                    URL: <a href="https://ftschamp.com">https://ftschamp.com</a>
                  </li>
                  <li>
                  ...
                  />
                  <li>
                    If the username and password are correct, they gain access
                    to the application.
                  </li>
                  <li>
                    Upon entering correct login credentials, users experience a
                    successful login, granting them access to the Web
                    Application.
                  </li>
                  <li>
                    If the user credentials are incorrect, a popup notification
                    at the top right corner of the screen shows in red colour –
                    “Username or Password incorrect”.
                  </li>
                  <li>
                    If the user clicks on forget password, it redirects to reset
                    password page, where he can reset the password by entering
                    their username and email ID.
                  </li>
                  <img
                    src={Reset_page}
                  ...
                  />
                  <li>
                    Once the user enters the username and email ID, the user
                    gets an autogenerated password at the valid email address
                    entered. The user can go back to the
                    <br />
                    login page and login using that password.
                  </li>
                  <li>
                    The user is advised to change the password to a new one once
                    they login as the emailed password is not so safe and hard
                    to remember.
                  </li>
                </ul> */}
                <div className="flex justify-center my-4">
                  <ul className="text-center space-y-4">
                    <li>
                      ...
                      as the initial gateway to access the various features and
                      functionalities it offers.
                    </li>
                    <li>
                      Users initiate their account with the FTS Web Application
                      by landing on the login page via the URL below.
                    </li>
                    <li>
                      URL:{" "}
                      <a
                    ...
                    <li>
                      Upon entering correct login credentials, users experience
                      a successful login, granting them access to the Web
                      Application.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      reset password page, where they can reset the password by
                      entering their username and email ID.
                    </li>
                    <img
                      src={Reset_page}
                      alt="Reset Page Screenshot"
              ...
              <div className="flex justify-center my-4">
                <div className="dashboard text-center space-y-4" id="Dashboard">
                  <h1 className="text-2xl font-bold">DASHBOARD</h1>
                  <ul className="space-y-4">
                    <li>
                      After a successful login, users are seamlessly directed to
                      the dashboard – a centralized interface designed to
                    ...
                    <li>
                      ...
                      easy access to different application sections, and a main
                      area displaying essential data.
                    </li>
                    <li>
                      <b>Navigation Panel:</b> The left navigation panel serves
                      as a quick and intuitive way for users to navigate between
                      different sections of the application. It includes links
                      to areas such as:
                    </li>

                    <div id="navigation-panel" className="flex justify-center">
                      <ol className="ulpaddingLeft list-decimal space-y-2 text-left">
                        <li>Dashboard</li>
                        <li>Donors</li>
                        <li>Receipts</li>
                        <li>Schools</li>
                    ...
                    <li>
                      All the details displayed in the dashboard are pertaining
                      to the ‘Current Year’ mentioned at the bottom of the
                      screen.
                    </li>
                  </ul>
                </div>
              ...
              <div className="flex justify-center my-4">
                <div className="donors text-center space-y-4" id="Donors">
                  ...
                  <div className="donor-list space-y-4" id="Full List">
                    <ul className="ulpaddingLeft list-disc space-y-2 text-left">
                      <li>
                        Full List
              ...
              <div className="flex justify-center my-4">
                <div className="donor-list-2 text-center space-y-4">
                  <h1 className="text-2xl font-bold">DONORS</h1>
                  <p>The donors tab consists of 3 lists, namely:</p>
                  <ul className="ulpaddingLeft list-disc text-left space-y-4">
                    <li>
                      ...
                      view, edit, and receipt button where users can view, edit
                      their details or get the receipt of the donation.
                    </li>
                    <img
                      src={Donor}
                      alt="donor Screenshot"
                      className="donor-img-1 mx-auto my-4"
                    />
                    <li>
                      In the Donor List page, the user can also add a new donor
                      to the list using ‘Add Individual’ or ‘Add Company’
                      buttons on the top right of the screen based on the donor
                      type.
                    </li>
                    <img
                      src={Company_donor}
                    ...
                    <li>
                      ...
                      desired promoter isn’t found, the user can select ‘other’
                      for a manual entry.
                    </li>
                    <li>
                      By selecting the view option in the action column, the
                      user can access all details about a donor, view ‘Old
                      Receipts’ for that donor, and see ‘Receipt Details’ which
                      includes family group or company receipts.
                    </li>
                    <img
                      src={Donor_detail}
                      alt="donor Screenshot"
                    ...
                    />
                    <li>
                      Scrolling further in the donor details page reveals family
                      and company details of the donors.
                    </li>
                    <img
                      src={Donor_detail2}
                      alt="donor Screenshot"
                    ...
                    <li>
                      ...
                      donor pays ₹1000, they are subscribed for 1 year. If they
                      pay ₹2000, it covers 2 years.
                    </li>
                    <img
                      src={Member}
                    ...
                    <li>
                      ...
                      <ul className="list-disc pl-6 space-y-2">
                        ...
                        <li>
                          <b>Step 2:</b> If receipt count is one or more, retain
                          the preferred entry and note the FTS ID, then use the
                          edit button to remove duplicates.
                        </li>
                        <img
                          src={Duplicate2}
                          alt="duplicate Screenshot"
                        ...
                        />
                        <li>
                          <b>Step 3:</b> Confirm the duplicate entry for merging
                          with the original entry.
                        </li>
                        <li>
                          <b>Step 4:</b> Save the changes to eliminate the
                          duplicate, merging all receipts to the retained donor
                          ID.
                        </li>
                      </ul>
                    </li>
              ...
              <div className="flex justify-center my-4">
                <div className="managing text-center space-y-4">
                  ...
                  <ul className="ulpaddingLeft list-disc text-left space-y-4">
                    <li>
                      Donor group means when a donor’s family member or company
                      also donates, their donation receipts can be viewed or
                      downloaded at once.
                    </li>
                    <li>
                      After the donor is created, in the donors list, click on
                      the view button to access the donor details. Scroll below
                      to find the family details and company details.
                    </li>
                    <li>
                      Click on ‘Add Family Member’ or ‘Add Company’ to add a new
                      individual or a new company related to the existing donor.
                    </li>
                    <li>
                      On clicking, the same screen as creating an individual or
                      company appears where the details can be filled and
                    ...
                    />
                    <li>
                      If there already exists a donor or a company who should be
                      added as a family member or company of another donor, the
                      user should go to the full donors list screen.
                    </li>
                    <li>
                    ...
                    />
                    <li>
                      At the bottom right of the screen, click on the ‘Attach to
                      group’ button, and a popup appears to select the donor
                      group for attachment. Click ‘Add’ to assign them to the
                      respective donor group.
                    </li>
                    <img
                      src={Add_Group}
                      alt="donor Screenshot"
                    ...
                    />
                    <li>
                      After the donors are grouped, their donation details will
                      appear together in the ‘receipt details’ section as shown
                      below.
                    </li>
                    <img
                      src={Add_Group2}
              ...
              <div className="flex justify-center my-4">
                <div className="receipts text-center space-y-4">
                  ...
                  <p>
                    To create a receipt, the user has to adhere to the following
                    steps:
                  </p>
                  <ul className="ulpaddingLeft list-disc text-left space-y-4">
                    <li>
                    ...
                    <li>
                      <b>Step 3:</b> Click on the ‘Receipt’ button under Actions
                      adjacent to the donor whose receipt needs to be created.
                    </li>
                    <img
                      src={Action}
                    ...
                    <li>
                      ...
                      click on submit. The receipt will be created, and the user
                      will be redirected to the list view of receipts.
                    </li>
                  </ul>
                </div>
              </div>

              <div id="details" className="text-center space-y-4 my-6">
                ...
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  <li>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        The donors contributing under 80G are exempted from tax
                        payment.
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        For instance, if a donor contributes less than ₹22K, say
                        ₹20K, it will be registered under ‘General Donation’.
                      </li>
                      <li>
                        Similarly, if a donor contributes more than ₹22K, for
                        example, ₹45K, the donation amount is split as 22K twice
                        for school donation, with the remaining ₹1K allocated to
                        general donation.
                      </li>
                      <li>
                      ...
                      <li>
                        The donation year should also be selected in the ‘school
                        allotment year’ field for which year the donation is
                        being made.
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        The remarks section is only for internal use and doesn’t
                        appear in any copies of receipts or communications with
                        donors.
                      </li>
                    </ul>
                  </li>
              ...
              <div id="Receipts" className=" section space-y-4 my-6">
                ...
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  ...
                  <li id="Edit list">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        Once the user creates the receipt, they cannot edit it.
                        If the receipt needs to be edited, they need to request
                        the secretary for the same.
                      </li>
                    </ul>
                  </li>
                  <li id="Suspense list">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      ...
                      <li>
                        ...
                        entries whose receipts are created on the payment date.
                      </li>
                      <li>
                        Using the edit button, the suspense entry can be edited
                        by the user as and when the donor is identified. The
                        suspense entry eliminates the errors of duplicate
                        entries when the donor claims the donation and requests
                        a receipt.
                      </li>
                      <li>
              ...
              <div className="school space-y-4 my-6" id="Schools">
                ...
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  <li id="School list">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        ...
                        Cluster, Sub-Cluster, Village, School Code, Status, and
                        Action.
                      </li>
                      <img
                        src={Schools_list}
                      ...
                      <li>
                        ...
                        details and the Donor’s FTS ID who has donated for that
                        school.
                      </li>
                      <img
                        src={School_detail}
                      ...
                      />
                      <li>
                        The status column shows if the school has been allotted
                        to a donor or not.
                      </li>
                    </ul>
                  </li>
                  <li id="School to Allot">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        The donors visible in this list are only those who have
                        created the receipt for ‘One Teacher School’. They
                        consist of Donor Name, Type, Mobile, Email, Allotment
                        Year, OTS Received, and Allotment.
                      </li>
                      <li>
                  ...
                  <li id="Alloted School">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      ...
                      <li>
                        ...
                        the same, and in the receipts button, the user can view,
                        download the PDF, and print the acknowledgment letter
                  ...
                  <li id="Repeat Donors">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        The repeated donors who contribute more than once can be
                        viewed and created under 'Repeat Donors'.
                      </li>
                      <img
                        src={Repeat_donor}
                        alt="school screenshot"
              ...
              <div id="Reports" className="reports space-y-4 my-6">
                ...
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  <li id="Donor Summary">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        ...
                        ‘Group View’ to look at the kind of report he/she wants.
                      </li>
                      <img
                        src={Donor_summary}
                  ...
                  <li id="Receipt Summary">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        ...
                        selected date period. The user can view and download the
                        report between the selected dates.
                      </li>
                      <img
                        src={Receipt_summary}
                  ...
                  <li id="School Summary">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        ...
                        donor, the user can view and download the number and all
                        the details of the schools he/she has donated to so far.
                      </li>
                      <img
                        src={School_summary}
                  ...
                  <li id="10BD Statement">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        The 10BD form can be viewed using this tab. The user can
                        select the dates in between which he/she wants its
                        ...
                        Group and View Group where the user can view or download
                        the reports groupwise.
                      </li>
                      <img
                  ...
                  <li id="Suspense Summary">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        This tab gives out the report of the Chapter, Year, and
                        Number of suspense donations in total.
                      </li>
                      <img
                  ...
                  <li id="Payment Summary">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        Under this tab, users can view and download the reports
                        of all the payments between selected dates as per their
                        requirement.
                      </li>
                      <img
                        src={Payment_summary}
              ...
              <div id="Download" className="downloads space-y-4 my-6">
                <h1 className="text-2xl font-bold">Downloads</h1>
                <p>
                  This tab allows the user to download the specific data of the
                  following:
                </p>
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  <li id="Download Receipt">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        The user can download the receipts between the selected
                        dates, along with the required purpose, category, and
                  ...
                  <li id="Download School">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        The user can download the records of either the allotted
                        schools or the unallotted schools within the starting
                        and ending dates.
                      </li>
                      <img
                        src={Download_school}
              ...
              <div id="Others" className="others space-y-4 my-6">
                ...
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  ...
                  <li id="Team">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        This is to create a committee member who becomes one of
                        the team. The committee list is right under the creation
                        form.
                      </li>
                      <img src={Team} alt="Team screenshot" className="team" />
                    </ul>
                  </li>
                  <li id="Notices">
                    <b>Notices:</b>
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        Any notifications posted by the head office to its users
                        can be viewed in this tab. The user should acknowledge
                        these notices mandatorily.
                      </li>
                      <img
                        src={Notices}
              ...
              <div
                ...
                className="basic-fundamentals space-y-4 my-6"
              >
                <h1 className="text-2xl font-bold">Basic Fundamentals</h1>
                <p>
                ...
                <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      ...
                      <li>
                        The left button is used to hide or unhide the navigation
                        panel.
                      </li>
                      <li>
                        The right button is used to view the application in full
                        screen.
                      </li>
                      <img
                        src={Fundamental}
                  ...
                  <li id="Profile Creation">
                    ...
                    <ul className="list-disc pl-5 space-y-4">
                      <li>
                        At the top of the navigation panel, the user can access
                        their profile, where they can view and edit their name
                        and contact number and click on ‘Update Profile’ to save
                        the changes. However, the email ID cannot be edited.
                      </li>
                      <img
                        src={User_profile}
              ...
              <div
                id="Secretary Manual"
                className="secretary my-6 flex justify-center"
              >
                <div className="text-center space-y-4">
                  ...
                  <ul className="ulpaddingLeft list-disc text-left space-y-4 pl-5">
                    <li>
                      To create new users, view and edit existing user details.
                      <img
                        src={New_user}
                    ...
                    <li>
                      To change the signing authority of the chapter if and when
                      needed (this feature is available under updating the
                      chapter details. Refer to the above images for the same).
                    </li>
                    <li>
                      To edit the details in the receipts of donors. The
                      secretary must mandatorily mention the reason for editing
                      the details.
                      <img
                        src={Any_action}
                        alt="Edit action"
              ...
              <div
                id="Viewer Manual"
                className="viewer my-6 flex justify-center"
              >
                <div className="text-center space-y-4">
                  <h1 className="text-2xl font-bold">Viewer Manual</h1>
                  <ul className="ulpaddingLeft list-disc text-left space-y-4">
                    <li>
                      The viewer is only authorized to view all details related
                    ...
                    <li>
                      ...
                      viewer to select the ‘Chapter’ where they can view records
...
export default ManualGuideBook;
